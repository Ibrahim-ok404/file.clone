...
CON=sol()
#------------------[ USER-AGENT ]-------------------#
ua = ["Mozilla/5.0 (Linux; Android 9; itel L6005 Build/PPR1.180610.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/79.0.3945.116 Mobile Safari/537.36",]
...
for xd in range(10000):
	ugen=[]
for ibrahim in range(5):
    a='Mozilla/5.0 (Linux; Android)'
    b=random.choice(['5','6','7','8','9'])
    c='itel L6005 Build/PPR1.180610.011; wv'
